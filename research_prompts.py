...
This file contains all prompt templates that will be used in the research workflow components,
including scope clarification, research brief generation, and report synthesis.
"""
